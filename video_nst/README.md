...
This repo is a wrapper around [my implementation of fast NST](https://github.com/gordicaleksa/pytorch_nst_feedforward) (for static images) and it additionally provides:
...
4. Run `resource_downloader.py` (from pytorch_nst_feedforward submodule) it will download 4 pretrained models

...
def stylization(frames_path, model_name, img_width, stylization_batch_size):
    ...
    if len(os.listdir(stylized_frames_dump_dir)) == 0:
        ...
        stylization_script_path = os.path.join(os.path.dirname(__file__), os.path.pardir, 'pytorch_nst_feedforward', 'stylization_script.py')
        ...
        if return_code == CUDA_EXCEPTION_CODE:  # pytorch_nst_feedforward will special code for CUDA exception
